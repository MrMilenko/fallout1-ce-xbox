...
{
    // DbgPrint("GNW_input_init: calling dxinput_init()\n");
    if (!dxinput_init()) {
        // DbgPrint("GNW_input_init: dxinput_init failed\n");
        return -1;
    }

    // DbgPrint("GNW_input_init: calling GNW_kb_set()\n");
    if (GNW_kb_set() == -1) {
        // DbgPrint("GNW_input_init: GNW_kb_set failed\n");
        return -1;
    }

    // DbgPrint("GNW_input_init: calling GNW_mouse_init()\n");
    if (GNW_mouse_init() == -1) {
        // DbgPrint("GNW_input_init: GNW_mouse_init failed\n");
        return -1;
    }

    // DbgPrint("GNW_input_init: calling GNW95_input_init()\n");
    if (GNW95_input_init() == -1) {
        // DbgPrint("GNW_input_init: GNW95_input_init failed\n");
        return -1;
    }

    // DbgPrint("GNW_input_init: calling GNW95_build_key_map()\n");
    GNW95_build_key_map();

    // DbgPrint("GNW_input_init: calling GNW95_clear_time_stamps()\n");
    GNW95_clear_time_stamps();

    // DbgPrint("GNW_input_init: setting input vars\n");
    ...
    // DbgPrint("GNW_input_init: setting idle func\n");
    set_idle_func(idleImpl);

    // DbgPrint("GNW_input_init: complete\n");
    return 0;
}
