...
{
    // DbgPrint("init_options_menu(): starting\n");

    for (int index = 0; index < 11; index++) {
        btndat[index].direction = 0;
    }
    // DbgPrint("init_options_menu(): btndat cleared\n");

    // DbgPrint("init_options_menu(): calling SetSystemPrefs()\n");
    //SetSystemPrefs();
    // DbgPrint("init_options_menu(): SetSystemPrefs done\n");

    // DbgPrint("init_options_menu(): calling InitGreyTable\n");
    //InitGreyTable(0, 255);
    // DbgPrint("init_options_menu(): InitGreyTable done\n");
